...
class pre_order_traversal
    : public traversal<Container, pre_order_traversal<Container, Predicate>,
                       Predicate> {
 public:
  using base_type =
      traversal<Container, pre_order_traversal<Container, Predicate>,
                Predicate>;
...
pre_order_traversal<Container, Predicate>::pre_order_traversal() {}
...
template <typename Container, typename Predicate>
bool pre_order_traversal<Container, Predicate>::traverse(link_type link) {
...
template <typename Container, typename Predicate>
bool pre_order_traversal<Container, Predicate>::next() {
  auto moved = false;
  prev_pos_ = position();
