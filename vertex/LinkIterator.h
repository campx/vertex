...
template <typename Container>
typename LinkIterator<Container>::self_type LinkIterator<Container>::begin()
    const {
  return self_type(*vertices_, parent_, parent_->links().begin());
}

template <typename Container>
typename LinkIterator<Container>::self_type LinkIterator<Container>::end()
    const {
...
template <typename Container>
typename LinkIterator<Container>::reference
    LinkIterator<Container>::operator*() {
...
template <typename Container>
typename LinkIterator<Container>::pointer
    LinkIterator<Container>::operator->() {
  return &(*this);
}
