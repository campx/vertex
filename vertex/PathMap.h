...
#include <vertex/IteratorRecorder.h>
#include <vertex/IteratorTransformer.h>
#include <vertex/PreOrderTraversal.h>
#include <vertex/SequencePredicate.h>
#include <algorithm>
#include <functional>
#include <vector>
...
template <typename Container, typename Compare>
const typename Container::const_iterator& PathMap<Container, Compare>::root()
    const {
  return root_;
}

template <typename Container, typename Compare>
PathMap<Container, Compare>& PathMap<Container, Compare>::root(
