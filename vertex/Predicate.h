...
template <typename Container, bool Result>
bool NullaryPredicate<Container, Result>::operator()(
    const typename NullaryPredicate<Container, Result>::argument_type& value)
    const {
  (void)value;
  return Result;
}
...
template <typename Container>
bool MaxDepthPredicate<Container>::operator()(
    const typename MaxDepthPredicate<Container>::argument_type& value) {
