...
template <typename NodeMap>
Tree<NodeMap>::Pin::Pin(Pin&& other) noexcept
...
template <typename NodeMap>
void Tree<NodeMap>::Mapping::set(
    typename Tree<NodeMap>::objex_iterator input,
...
template <typename NodeMap>
typename Tree<NodeMap>::objex_iterator Tree<NodeMap>::Mapping::get(
    typename Tree<NodeMap>::objex_iterator input)
